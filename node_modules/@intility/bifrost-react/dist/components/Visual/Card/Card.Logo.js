 ...
 */
var CardLogo = /*#__PURE__*/(0, _react.forwardRef)(function (_ref, ref) {
  var className = _ref.className,
      style = _ref.style,
      icon = _ref.icon,
      imageUrl = _ref.imageUrl,
      props = _objectWithoutProperties(_ref, ["className", "style", "icon", "imageUrl"]);

  return /*#__PURE__*/_react.default.createElement("div", _extends({}, props, {
    className: (0, _classnames.default)('bf-card-logo', className),
    ref: ref,
